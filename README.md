...
- __Kalender Konto__ ([Dokumentation](Kalender%20Konto))  
	Verbindet Apple-iCloud-, Google-Calendar- und CalDAV-Konten sowie iCalendar-Feeds, löst wiederkehrende Feed-Termine lokal auf und stellt die Kalender bereit.
